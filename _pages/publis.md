...
* Oscar Alberto Carrillo Rozo.
  ...
  PhD thesis, Université de Franche-Comté, 2015. ([pdf version]({{ site.url }}{{ site.baseurl}}/assets/publis/thesis.pdf), [slides]({{ site.url }}{{ site.baseurl}}/assets/publis/slides.pdf)).
